...
namespace overlay {
    ...
    public:
         ...
         * enables resizing (with a custom borderless style via Win32), and sets up the OpenGL context and ImGui environment.
         *
         ...
         * @return true if the window should close (for example, user clicked the close button), false otherwise.
         */
