...
namespace screenshot {
    ...
    public:
         ...
         */
        static bool saveBitmapToFile(const std::string& filename, const ScreenshotProcessor::BITMAPINFO256 &bmpInfo256, const std::vector<BYTE>& pixelData);
         ...
         */
        static std::vector<BYTE> createBitmapBuffer(const ScreenshotProcessor::BITMAPINFO256 &bmpInfo256, const std::vector<BYTE>& pixelData);
    };
}
