...
class OCRProcessor:
    ...
    def __init__(self, tesseract_cmd: str = None):
        ...
        :param tesseract_cmd: Path to tesseract executable. If provided, it is set for pytesseract.
        """
        if tesseract_cmd:
    ...
    def preprocess_image(self, image: np.ndarray) -> np.ndarray:
        ...
        Steps:
         ...
         - Invert the image colors (to have dark text on a light background).
    ...
    def extract_server_id(self, image: np.ndarray) -> str:
        """
    ...
    def process_image(self, image_bytes: bytes) -> str:
        ...
        return self.extract_server_id(processed_image)
